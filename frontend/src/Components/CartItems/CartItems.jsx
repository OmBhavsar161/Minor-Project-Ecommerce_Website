    ...
    <div className="container mx-auto p-6 bg-gray-50 rounded-lg shadow-md">
        ...
        if (cartItems[e.id] > 0) {
          return (
            <div key={e.id} className="grid grid-cols-6 gap-4 items-center py-4 border-b border-gray-300">
              ...
              <button className="ml-2 w-12 h-12 flex items-center justify-center rounded-full bg-gray-200 text-gray-800 font-medium text-lg hover:ring-2 ring-green-300">{cartItems[e.id]}</button>
      ...
      <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <button className="w-full bg-green-600 text-white uppercase py-3 px-4 mt-6 rounded-lg hover:bg-green-700 transition-colors">
            Proceed To Checkout
          </button>
        </div>
      </div>
