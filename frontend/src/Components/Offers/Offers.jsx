  ...
  return (
    <div className='flex w-[90%] h-[80vh] m-auto py-0 px-[140px] mb-[150px] bg-gradient-to-r from-purple-300 via-cyan-300 to-pink-300 rounded-lg'>
      <div className="flex flex-1 flex-col justify-center ">
        ...
        <button className='w-[282px] h-[70px] bg-red-600 rounded-[35px] border-none text-white text-[22px] font-medium mt-[30px] hover:text-red-600 hover:bg-white hover:ring-red-600 hover:ring-4 '>Check Now</button>
      </div>
